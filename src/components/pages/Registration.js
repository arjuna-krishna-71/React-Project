        ...
        <div className="text-center">
            ...
            <div className="m-5 card w-50 h-50 d-flex">
                <form onSubmit={handleSubmit}>
                    ...
                    <input type="radio" value="user" name="userType" id="user" className="p-1"/><label htmlFor="user" className="text-dark p-1" onChange={handleChange}>User</label>
                    <input type="radio" value="admin" name="userType" id="admin" className="p-1"/><label htmlFor="admin" className="text-dark p-1" onChange={handleChange}>Admin</label><br/>
                    </div>
